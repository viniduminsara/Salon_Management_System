...
public class InventoryOrderDetailModel {
    public static boolean saveOrderDetails(String orderId, ArrayList<OrderItemDetailDTO> items) throws SQLException {
    ...
    private static boolean save(String orderId, OrderItemDetailDTO inventory) throws SQLException {

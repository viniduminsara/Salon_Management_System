...
public class UserModel {
    ...
    public static UserDTO findUser(String userName, String password) throws SQLException, FileNotFoundException {
        ...
        if (rs.next()){
            ...
            return new UserDTO(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), inputStream,rs.getString(8));
        }
        return null;
    }
    ...
    public static boolean updateWithoutImage(UserDTO user) throws SQLException {
    ...
    public static UserDTO getUser(String userId) throws SQLException, FileNotFoundException {
